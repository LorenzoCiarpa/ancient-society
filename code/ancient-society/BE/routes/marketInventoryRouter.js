...
if(serverConfig.routes.marketplace){
    ...
    router.post("/getTotalListingPvp", marketInventoryController.getTotalListingPvp);
    router.post("/getCheapestInventoriesPvp", marketInventoryController.getCheapestInventoriesPvp);
    ...
    router.post("/buyInventoryPvp", marketInventoryController.buyInventoryPvp);
