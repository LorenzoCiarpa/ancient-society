    ...
    alpha: {
        ...
        polygon: {
            ...
            contracts: {
                ...
                MATIC_REWARD_ADDRESS: '0xa1490A2EbB6a5bBD218a8ED31104fdDB59D215d8',
                VOUCHER_MATIC_REWARD_ADDRESS: '0x32eD645D7Fa41Cf31e63D256D0bf581cc9EDFa38'
        ...
        ethereum: {
            ...
            httpWeb3: new Web3(new Web3.providers.HttpProvider(endpoint.ethereum.HTTP_GETBLOCK)),
            wssWeb3: new Web3(new Web3.providers.WebsocketProvider(endpoint.ethereum.WSS_GETBLOCK[0], options))
        }
    },
    ...
    omega: {
        ...
        polygon: {
            ...
            contracts: {
                ...
                STAKER_FISHERMAN_ADDRESS_OLD: '0xFCeC0e93bc1761D32309f146253E2Ad9a2b20781',
                STAKER_MINER_ADDRESS_OLD: '0xA09575E5FB1A715cD01Daa2E8349FA8840Dda6A3',
                STAKER_FARMER_ADDRESS_OLD: '0xFCeC0e93bc1761D32309f146253E2Ad9a2b20781',
                ...
                ANCIENT_OMEGA_MARKETPLACE: '0xD336af2de2832d0320C47C91C5F8bC46344941F5',
                ANCIENT_OMEGA_MARKETPLACE_ETH: '0x77C6DA1916F16488Ce1a22ef5FF3812a559BF3BA',
                AIRDROP_OMEGA_BUNDLE_NO_MINER: '0xA1805b7fa26580c4183eb3cCe1B1f75fD9EB8F89'
...
const serverConfig = {
    ...
    MAX_FOREST_COMMON: '15',
    MAX_BUILDINGS_TOWNHALL_SHOP: '100',
    MAX_BUILDINGS_LUMBERJACK_SHOP: '200',
    MAX_BUILDINGS_STONEMINE_SHOP: '200',

    MAX_NUMBER_VALUE: '1000000000',
    MAX_VOUCHER_VALUE: '15000',
    ...
    WELCOME_MESSAGE: 'Welcome to Ancient Society',
    ...
    pvpdatabase: database.pvp_db,
    routes: routes.alpha,
    options: options,
    buildingLevel: buildingLevel.alpha,

    cooldownSec: {
        fisherman: 30 * 60,
        miner: 23.5 * 60 * 60,
        farmer: 23.5 * 60 * 60,
        battleExpireTime: 23.5 * 60 * 60,
    },
...
if (process.env.SERVER == 'alpha') {
    ...
    chain_info = chain_info.alpha_new;
}
...
if (process.env.SERVER == 'dev') {
    serverConfig.buildingLevel = buildingLevel.alpha;
    serverConfig.routes = routes.dev;
...
if (process.env.DB == 'alpha_db_new') {
    serverConfig.database = database.alpha_db_new;
}
...
if (process.env.DB == 'challenge_db') {
    serverConfig.database = database.challenge_db;
}
