...
async function reconnect(){
    ...
    //MUMBAI
    // let provider_mumbai = new Web3.providers.WebsocketProvider(serverConfig.endpoint.mumbai.WSS_GETBLOCK[serverConfig.indexEndpoint], serverConfig.options)
    // serverConfig.chain.mumbai.wssWeb3.setProvider(provider_mumbai);
    
    //ETHEREUM MAINNET
    // let provider_eth = new Web3.providers.WebsocketProvider(serverConfig.endpoint.ethereum.WSS_GETBLOCK[serverConfig.indexEndpoint], serverConfig.options);
...
// setInterval(reconnect, 1000 * 60 * 2);
