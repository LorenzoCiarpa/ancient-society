      ...
      <>
        <div className='mintComponent omega'>
            ...
            {this.state.listingSelected &&
              ...
              <div className='mintReferral'>
                <span>
                  ...
                  Do you have a Referral Wallet?
                </span>
                <input 
                  type='string' 
                  value={this.state.mintReferral}
                  onChange={e => this.setState({mintReferral: e.target.value})}
                />
              </div>
              </>
              }
          ...
          {this.state.page == 'referral' ?
            <div className='mintContainer referral'> 
              
              <div className='referral-infos'>
                <div className='referral-info'>
                    <h2>Generate your Referral Link</h2>
                    <p>
                      The Wallet Address you are registered with in Omega Server:
                    </p>
                    <input 
                      className='referral-input my-wallet'
                      type='string' 
                      value={this.state.myWallet}
                      onChange={e => this.setState({myWallet: e.target.value})}
                      placeholder='0x0000... No ENS!'
                    />
                    <Button 
                      className='btnUI'
                      onClick={()=>{
                    ...
                    >Generate</Button>
                    <br/>
                    {this.state.myReferralLink ?
                    <div className='referral-input-container'>
                      <input 
                        className='referral-input my-link'
                        value={this.state.myReferralLink}
                        readOnly/>
                      <ContentCopyIcon 
                        className='copy-icon'
                        sx={{ fontSize: 25, color: 'white' }} 
                        onClick={
                          navigator.clipboard.writeText(this.state.myReferralLink)
                        }/>
                    </div>
                ...
                <div className='referral-info'>
                  ...
                  <p>
                    Refer a Friend (RaF) is a system that rewards you for bringing attention to Ancient Society.
                  </p> <p>
                    You can share your Wallet as a Referral Wallet for New Players joining Ancient Society.
                  </p> <p>
                    Each time someone buys any Building - Bundle, they can write down a Referral Wallet.
                  </p> <p>
                    The player Buying something will receive an in-game bonus, and the one who shared the Referral Wallet will receive Referral Points (RF).
                  </p>
                </div>

                <div className='referral-info'>
                  <h2>What Are Referral Points (RF)?</h2>
                  <p>
                  You receive 1 RF for each USD spent to mint by the Players using your Referral Wallet.
                  </p> <p>
                  Referral Points can be used in many ways in the Ecosystem.
                  </p> <p>
                  RF can be exchanged for MATIC (1 RF = 0,30 MATIC), they can be used to mint Bundles or can be used to buy special Rewards.
                  </p> <p>
                  The more RF you trade in a single transaction, the more value you will get by them.
                  </p>
                </div>

                <div className='referral-info'>
                  <h2>How to Obtain Referral Points</h2>
                  <p>
                  Simply give your Wallet to interested players that will use it to receive in-game rewards while minting.
                  </p> <p>
                  To get attention and sponsor your Referral you can use different strategies such as:
                  </p> <p>
                    <ul>
                    <li>Hosting or Joining Twitter Spaces</li>
                    <li>Tweet Posts - Threads</li>
                    <li>Content (YouTube Videos - Articles etc)</li>
                    </ul>
                  </p>
                </div>

                <div className='referral-info'>
                  <h2>How to Spend Referral Points</h2>
                  <p>
                  You can use RFs to mint new Bundles - Buildings.
                  </p> <p>
                  You can directly trade them for 1 RF = 0,30 MATIC.
                  </p> <p>
                  RFs can also be used to get exclusive rewards.
                  </p>
                </div>

                <div className='referral-info'>
                  <h2>Leaderboard Referral Points</h2>
                  <p>
                  There is a Leaderboard for the RF generated through your Wallet.
                  </p> <p>
                  The Referrals who generated the most points will receive airdrops and Special Rewards such as High Tier Referral Privileges. 
                  </p> <p>
                  (For example having a better exchange rate between RF and MATIC)
                  </p>
                </div>
              </div>
        ...
        >
            <Typography sx={{ p: 1 }}>
                If you insert a valid Referral Wallet you'll receive some extra in-game items!
            </Typography>
        </Popover>
