...
import PolygonStudio from './assets/polygon-studio.png';
import TensetInfinity from './assets/tenset-infinity.webp';
    ...
    <div className='Partners'>
      <div className='partners-list'>
        ...
        <a href='https://www.digitalocean.com/' target="_blank">
          <img className='partner-orizontal' src={DigitalOcean}/>
        </a>
        ...
        <a href='https://polygonstudios.com/' target="_blank">
          <img className='partner-orizontal' src={PolygonStudio}/>
        </a>
        <a href='https://bridge.umbria.network/bridge/ethereum-polygon/eth#' target="_blank">
          <img className='partner' src={Umbria}/>
        </a>
        <a href='https://www.infinity.tenset.io/' target="_blank">
          <img className='partner' src={TensetInfinity}/>
        </a>
      </div>
    </div>
  )
