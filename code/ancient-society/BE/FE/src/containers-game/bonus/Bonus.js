...
function Bonus/* Component_Name_You_Want */(props) {
    ...
    const onSelectConsumable = (consumableInfo) => {
        ...
        if (consumableInfo.idItemConsumableBonus == 11 || consumableInfo.idItemConsumableBonus == 12 || consumableInfo.idItemConsumableBonus == 13) {
            onDoAction(consumableInfo.type + " II");
        } else {
    ...
    const proceedAction = () => {
        ...
        } else if (confirmActionType == 'ELEVATE' || confirmActionType == 'ELEVATE II') {
            axios({
                method: 'post',
    ...
    const onDidAction = (response) => {
        ...
        if (response.data.success) {
            ...
            if (confirmActionType == 'REROLL' || confirmActionType == 'ELEVATE' || confirmActionType == 'ELEVATE II') {
                setSelectedBonus({ uid: '' });
            }
