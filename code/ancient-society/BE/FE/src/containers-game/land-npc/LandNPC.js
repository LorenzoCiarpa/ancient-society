...
const classNameForComponent = 'game-craft-inventory land-npc' // ex: game-inventory
const componentTitle = 'Land Emporium' // ex: Inventory
const hasTab = true // true if this component has tabs
const tabNames = ['Common', 'Rare', 'Legendary'] // tab display names

function LandNPC/* Component_Name_You_Want */(props) {
    ...
    useEffect(() => {
        ...
        axios({
            method: 'post',
            url: '/api/m1/inventory/getRecipeLandNPC',
            data: {
    ...
    const onInventoryClick = (inventory) => {
        ...
        axios({
            method: 'post',
            url: '/api/m1/inventory/getRecipeLandNPCInstance',
            data: {
                address: props.metamask.walletAccount,
    ...
    const onCraft = () => {
        ...
        axios.post('/api/m1/inventory/craftLandNPC', {
            address: props.metamask.walletAccount,
            idDelegate: idDelegate,
            idColony: idColony,
...
export default LandNPC // Component_Name_You_Want