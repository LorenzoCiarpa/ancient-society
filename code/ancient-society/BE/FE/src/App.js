  ...
  return (
    <Router>
      <Routes>
        ...
        {process.env.REACT_APP_SERVER == 'omega'
        ...
        <Route path='/mint-whitelist/' element={<Mint />} />
        ...
        {serverConfig?.pages.multichainMint
          && <Route path='/miner' element={<MultichainMint />} />}

        {/* pvp system */}
        {serverConfig?.pages.pvp && <Route path='/pvp/' element={<PVP />} />}
