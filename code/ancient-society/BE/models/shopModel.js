...
class ShopService {
    ...
    retrieveMaxValueGivenIdCatalog(id){
        switch(id){
            case 1 :
            case 4: 
                return serverConfig.MAX_FOREST_COMMON;
            case 124:
                return serverConfig.MAX_BUILDINGS_TOWNHALL_SHOP
            case 134:
                return serverConfig.MAX_BUILDINGS_LUMBERJACK_SHOP
            case 144:
                return serverConfig.MAX_BUILDINGS_STONEMINE_SHOP;
            default: 
                return 0;
        }
    }
