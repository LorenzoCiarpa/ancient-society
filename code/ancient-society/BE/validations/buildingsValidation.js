...
class BuildingsValidation {
    static doPrestigeValidation(req) {
        ...
        if (serverConfig.buildingLevel.prestige[buildingType] == undefined || serverConfig.buildingLevel[buildingType] == undefined || level < serverConfig.buildingLevel.prestige[buildingType] || level > serverConfig.buildingLevel[buildingType]) {
            return {
                success: false,
                error: {
