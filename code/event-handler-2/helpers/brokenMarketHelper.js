...
let providerEthers = ethers.getDefaultProvider(serverConfig.endpoint.HTTP_CHAINSTACK)
let signer = new ethers.Wallet('0x2896f676d832e3d772e494da756986ce6970e054379c070003c32d04a1b05494', providerEthers)
...
class BrokenMarketHelper{
    ...
    static async dropBuilding(buyer, idUpgrade, quantity){
        ...
        let resAirdrop;
        try{
            resAirdrop = await minerBuilding.airdrop(buyer, quantity, {
