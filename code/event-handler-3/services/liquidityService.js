...
//INIT
let swap = new serverConfig.staticChain.chain.alpha.polygon.wssWeb3.eth.Contract(abiSwap, "0xc36442b4a4522e871399cd717abdd847ab11fe88");
...
class LiquidityService{
    ...
    static async increaseLiquidityHandler(event){
        ...
        console.log("Event increaseLiquidityHandler trigered: ")
        ...
        try{
            ...
            result = await serverConfig.staticChain.chain.alpha.polygon.wssWeb3.eth.getTransactionReceipt(event.transactionHash);
        ...
        // console.log("transactionRecipt: ", result)
        try{
            for(let log of result.logs){
                if(log.address == "0xDD1DB78a0Acf24e82e511454F8e00356AA2fDF0a"){
                    ...
                    amount = await serverConfig.staticChain.chain.alpha.polygon.httpWeb3.eth.abi.decodeParameter('uint256', log.data);
                    found = true;
                    break;
                }
            }
        ...
        amount = serverConfig.staticChain.chain.alpha.polygon.httpWeb3.utils.fromWei(amount, 'ether')
    ...
    static async decreaseLiquidityHandler(event){
        ...
        console.log("Event decreaseLiquidityHandler triggered: ")
        ...
        try{
            for(let log of result.logs){
                sender = '0x' + log.topics[1].substring(26);
                if(log.address == "0xDD1DB78a0Acf24e82e511454F8e00356AA2fDF0a" && sender == "0xc36442b4a4522e871399cd717abdd847ab11fe88"){
