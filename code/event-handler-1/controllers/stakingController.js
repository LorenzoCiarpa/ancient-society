...
const initListeners = () => {
    ...
    var myContractStakerThNew = new serverConfig.chain.wssWeb3.eth.Contract(stakerAbi, serverConfig.chain.contracts.STAKER_TOWNHALL_ADDRESS);
    ...
    var myContractStakerLjNew = new serverConfig.chain.wssWeb3.eth.Contract(stakerAbi, serverConfig.chain.contracts.STAKER_LUMBERJACK_ADDRESS);
    ...
    var myContractStakerSmNew = new serverConfig.chain.wssWeb3.eth.Contract(stakerAbi, serverConfig.chain.contracts.STAKER_STONEMINE_ADDRESS);
    ...
    var myContractStakerFmNew = new serverConfig.chain.wssWeb3.eth.Contract(stakerAbi, serverConfig.chain.contracts.STAKER_FISHERMAN_ADDRESS);
