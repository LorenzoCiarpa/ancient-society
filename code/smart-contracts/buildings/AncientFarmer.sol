...
contract AncientFarmer is ERC721Enumerable, Ownable {
    ...
    uint256 private MAX_FARMER = 4000;
    ...
    constructor() ERC721 ("AncientFarmer", "AFR") Ownable (msg.sender) {
        isMintOpen = true;
        baseURI = "";
    ...
    modifier onlyMinter(uint256 _numberOfTokens){
        ...
        require(totalSupply() + _numberOfTokens <= MAX_FARMER,"max-supply");
        _;
    }
