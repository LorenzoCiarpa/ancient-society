...
contract AncientFisherman is ERC721Enumerable, Ownable {
    ...
    uint256 private MAX_FISHERMAN = 4000;
    ...
    constructor() ERC721 ("AncientFisherman", "AFM") Ownable (msg.sender) {
        isMintOpen = true;
        baseURI = "";
    ...
    modifier onlyMinter(uint256 _numberOfTokens){
        ...
        require(totalSupply() + _numberOfTokens <= MAX_FISHERMAN,"max-supply");
        _;
    }
