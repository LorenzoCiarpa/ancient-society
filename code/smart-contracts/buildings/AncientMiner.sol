...
contract AncientMiner is ERC721Enumerable, Ownable {
    ...
    uint256 private MAX_MINER = 4000;
    ...
    constructor() ERC721 ("AncientMiner", "AMN") Ownable (msg.sender) {
        isMintOpen = true;
        baseURI = "";
    ...
    modifier onlyMinter(uint256 _numberOfTokens){
        ...
        require(totalSupply() + _numberOfTokens <= MAX_MINER,"max-supply");
        _;
    }
